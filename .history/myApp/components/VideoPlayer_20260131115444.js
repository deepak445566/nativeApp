...
export default function VideoPlayer({ 
  ...
  shouldLoop = true // New prop for loop control
}) {
  ...
  return (
    <View style={[
      ...
      <Video
        ...
        isLooping={shouldLoop} // Loop enable/disable
          ...
          <View style={styles.controlsRow}>
            ...
            <View style={styles.videoInfo}>
              <Text style={styles.videoTitle} numberOfLines={1}>
                {shouldLoop ? "Workout Loop Mode" : "Workout Session"}
              </Text>
            ...
            <View style={styles.rightControls}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  // You can add a callback to toggle loop from parent
            ...
            <TouchableOpacity 
              ...
              onPress={() => {
                if (videoRef.current && status?.durationMillis) {
                  const restartPosition = Math.max(0, status.durationMillis - 3000); // Last 3 seconds
