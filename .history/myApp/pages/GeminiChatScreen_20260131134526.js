...
export default function GeminiChatScreen({ navigation }) {
  ...
  const showWelcomeMessage = () => {
    const welcomeMessage = {
      role: 'assistant',
      content: "🍎 Welcome to AI Diet Planner! I'll help you create a personalized diet plan. Click 'Start Diet Planning' to begin!",
  ...
  const calculateDailyCalories = () => {
    ...
    const goalAdjustments = {
      weight_loss: tdee * 0.85,
      weight_gain: tdee * 1.15,
      muscle_building: tdee * 1.1,
      maintenance: tdee,
      toning: tdee * 0.9
    };
  ...
  const generateDietPlan = async () => {
    ...
    const dietPrompt = `Create a personalized diet plan:
    ...
    - Activity: ${dietFormData.activityLevel}
    - Goal: ${dietFormData.goal}
    - Diet: ${dietFormData.dietaryPreferences}
    - Allergies: ${dietFormData.allergies || 'None'}
    - Medical: ${dietFormData.medicalConditions || 'None'}
    
    Calculations:
    - BMI: ${bmi || 'N/A'}
    - Daily Calories: ${dailyCalories || 'N/A'}
    
    Create a comprehensive diet plan with:
    1. Daily meal breakdown
    2. Macronutrient distribution
    3. Food recommendations
    4. 7-day sample meal plan
    5. Hydration tips
    6. Tips for ${dietFormData.goal}
    ...
    try {
      ...
      sendMessage('Sorry, there was an error generating your diet plan. Please try again.');
    } finally {
        ...
        return (
          <View style={styles.formStep}>
            ...
            <Text style={styles.noteText}>
              Click "Generate Diet Plan" to create your personalized nutrition plan.
            </Text>
          </View>
        );
    }
