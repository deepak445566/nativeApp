...
export default function GeminiChatScreen({ navigation }) {
  ...
  const renderMessage = ({ item }) => {
    ...
    const isDietPlan = item.isDietPlan;
    ...
    return (
      <View style={[styles.messageRow, isUser ? styles.userRow : styles.aiRow]}>
        <View style={[styles.avatar, 
          ...
          isDietPlan ? styles.dietAvatar : styles.aiAvatar
        ]}>
          <Icon 
            name={
              isUser ? "person" : 
              isError ? "error" : 
              isDietPlan ? "restaurant-menu" : "restaurant"
            } 
            size={16} 
            color="white" 
          />
        ...
        <View style={[
          ...
          isDietPlan ? styles.dietBubble : styles.aiBubble
        ]}>
          {isDietPlan ? (
            ...
            <>
              <Text style={[
                ...
                isError ? styles.errorText : styles.aiText
              ]}>
                {item.content}
              </Text>
              <Text style={[
                ...
                isError && styles.errorMessageTime
              ]}>
                {new Date(item.timestamp).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
              </Text>
            </>
