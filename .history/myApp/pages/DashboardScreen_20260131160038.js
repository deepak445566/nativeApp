// pages/DashboardScreen.js (Complete with AI Assistant Icon in Header)
...
export default function Dashboard({ navigation }) {
  ...
  return (
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      {/* Enhanced Header with AI Assistant Icon */}
      <LinearGradient 
      ...
      >
        ...
        {/* Injury Predictor Card */}
        <TouchableOpacity 
          style={styles.injuryCard}
          onPress={() => navigation.navigate('InjuryPredictor')}
          activeOpacity={0.9}
        >
          <LinearGradient
            ...
            style={styles.injuryGradient}
          >
            <View style={styles.injuryContent}>
              <View style={styles.injuryIconContainer}>
                <Icon name="healing" size={32} color="white" />
              </View>
              <View style={styles.injuryTextContainer}>
                <Text style={styles.injuryTitle}>Injury Predictor</Text>
                <Text style={styles.injurySubtitle}>
                  Upload injury photo for AI analysis & temporary solutions
                </Text>
              </View>
