...
export default function Dashboard({ navigation }) {
  ...
  { name: "Butt Kicks", duration: 60, type: "cardio" },
  { name: "Fast Marching", duration: 120, type: "cardio" },
  ...
  { name: "Full Body Stretching", duration: 180, type: "cooldown" }
    ...
    { 
      ...
      exercises: 12,
      exercisesList: [
        { name: "Child's Pose", duration: 60, type: "warmup" },
        { name: "Downward Dog", duration: 45, type: "stretch" },
        { name: "Warrior I", duration: 30, type: "standing" },
        { name: "Warrior II", duration: 30, type: "standing" },
        { name: "Tree Pose", duration: 45, type: "balance" },
