...
export default function WorkoutSummaryScreen({ route, navigation }) {
  ...
  // ✅ Go to Dashboard with stack reset
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          >
            <Icon name="home" size={24} color="#1F2937" />
          ...
          <View style={styles.statsGrid}>
            ...
            <View style={styles.statCard}>
              ...
              <Text style={styles.statValue}>
                {Math.round((exercisesCompleted / workout.exercisesList.length) * 100)}%
              </Text>
        ...
        <View style={styles.progressCard}>
          ...
          <View style={styles.progressItem}>
            <View style={styles.progressInfo}>
              ...
              <Text style={styles.progressValue}>
                {exercisesCompleted} / {workout.exercisesList.length} exercises
              </Text>
            </View>
            <View style={styles.progressBar}>
              <View 
                style={[
                  styles.progressFill,
                  { 
                    width: `${(exercisesCompleted / workout.exercisesList.length) * 100}%`,
          ...
          <View style={styles.progressItem}>
            <View style={styles.progressInfo}>
              ...
              <Text style={styles.progressValue}>
                {formatTime(duration)} / {workout.duration || '30 min'} goal
              </Text>
            </View>
            <View style={styles.progressBar}>
              <View 
                style={[
                  styles.progressFill,
                  { 
                    width: `${Math.min((duration / (parseInt(workout.duration || 30) * 60)) * 100, 100)}%`,
          ...
          <View style={styles.progressItem}>
            <View style={styles.progressInfo}>
              ...
              <Text style={styles.progressValue}>
                {calories} / {workout.calories || 300} cal
              </Text>
            </View>
            <View style={styles.progressBar}>
              <View 
                style={[
                  styles.progressFill,
                  { 
                    width: `${Math.min((calories / (workout.calories || 300)) * 100, 100)}%`,
        ...
        <View style={styles.nextStepsCard}>
          ...
          <TouchableOpacity 
            style={styles.nextStepButton}
            onPress={() => {
              // This will navigate to ActiveWorkout but we need to handle video cleanup
              navigation.dispatch(
                CommonActions.reset({
                  index: 0,
                  routes: [
