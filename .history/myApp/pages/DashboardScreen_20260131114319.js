...
export default function Dashboard({ navigation }) {
  ...
  const workouts = [
    ...
    { 
      ...
      exercisesList: [
        [
  // 🔥 Warm-up (Home)
  { name: "High Knees", duration: 60, type: "warmup" },
  { name: "Jumping Jacks", duration: 60, type: "warmup" },

 
  { name: "Running in Place", duration: 180, type: "cardio" },
  { name: "Mountain Climbers", duration: 60, type: "cardio" },
  { name: "Jump Squats", sets: 3, reps: 15, type: "cardio" },
  { name: "Plank", duration: 45, type: "core" },
  { name: "Side Plank", duration: 45, type: "core" },
  { name: "Leg Raises", sets: 3, reps: 15, type: "core" },
  { name: "Bicycle Crunch", sets: 3, reps: 20, type: "core" },

  { name: "Full Body Stretching", duration: 180, type: "cooldown" }
]
  ...
  { name: "Cat–Cow Pose (Marjaryasana–Bitilasana)", duration: 60, type: "warmup" },

  // 🔄 Flow / Stretch
  { name: "Downward Facing Dog (Adho Mukha Svanasana)", duration: 45, type: "stretch" },
  { name: "Sun Salutation (Surya Namaskar)", duration: 180, type: "flow" },

  // 🧍 Standing Poses
  { name: "Warrior I (Virabhadrasana I)", duration: 30, type: "standing" },
  { name: "Warrior II (Virabhadrasana II)", duration: 30, type: "standing" },
  { name: "Triangle Pose (Trikonasana)", duration: 30, type: "standing" },

  // ⚖️ Balance
  { name: "Tree Pose (Vrikshasana)", duration: 45, type: "balance" },

  // 🔙 Backbend
  { name: "Bridge Pose (Setu Bandhasana)", duration: 45, type: "backbend" },
  { name: "Cobra Pose (Bhujangasana)", duration: 30, type: "backbend" },

  // 🪑 Seated / Hip Openers
  { name: "Seated Forward Fold (Paschimottanasana)", duration: 60, type: "stretch" },
  { name: "Butterfly Pose (Baddha Konasana)", duration: 45, type: "hip" },

  // 😌 Relaxation
  { name: "Corpse Pose (Shavasana)", duration: 120, type: "relaxation" }
]
