  ...
  const workouts = [
    { 
      ...
      exercisesList: [
        ...
        { name: "Mountain Climbers", duration: 45, type: "cardio" },
        { name: "Burpees", sets: 3, reps: 10, type: "fullbody" },
    ...
    { 
      ...
      exercisesList: [
        ...
        { name: "Jump Rope", duration: 300, type: "cardio" },
        { name: "Box Jumps", sets: 4, reps: 15, type: "cardio" },
        { name: "Burpee Tuck Jumps", sets: 3, reps: 10, type: "cardio" },
