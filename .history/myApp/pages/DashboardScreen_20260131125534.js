// pages/DashboardScreen.js (Updated - Today's Progress section removed)
  ...
  return (
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      ...
      >
        ...
        {/* Recent Activity (Optional - You can keep or remove this too) */}
...
// GoalCard component کو بھی ہٹا دیں کیونکہ اب اس کی ضرورت نہیں
const styles = StyleSheet.create({
  ...
  // Goals Grid related styles (ہٹا دیں)
  // goalsGrid: ...,
  // goalCard: ...,
  // goalHeader: ...,
  // goalIconContainer: ...,
